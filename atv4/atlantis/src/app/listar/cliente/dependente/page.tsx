...
export default function BuscarDependente() {
    ...
    return (
        <>
            <section className='container my-6'>
                <p className="title is-3 is-spaced">Listagem de Dependente</p>
                <div className="field is-grouped is-full">
                    <div className="control">
                        <label className="label">Insira o CPF do Dependente que deseja listar</label>
