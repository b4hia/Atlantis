...
export default function BuscarDependentesDeUmTitular() {
    ...
    return (
        <>
            <section className='container my-6'>
                <p className="title is-3 is-spaced">Listagem de Dependentes de um Titular</p>
                <div className="field is-grouped is-full">
                    <div className="control">
                        <label className="label">Insira o CPF do Titular</label>
