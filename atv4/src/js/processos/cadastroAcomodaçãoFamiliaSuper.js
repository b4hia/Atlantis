...
var CadastroAcomodacaoFamiliaSuper = /** @class */ (function (_super) {
    __extends(CadastroAcomodacaoFamiliaSuper, _super);
    function CadastroAcomodacaoFamiliaSuper() {
        var _this = _super.call(this) || this;
        _this.acomodacoes = armazem_1.default.InstanciaUnica.Acomodacoes;
        return _this;
    }
    CadastroAcomodacaoFamiliaSuper.prototype.processar = function () {
        var diretor = new diretorFamiliaSuper_1.default();
        this.acomodacoes.push(diretor.construir());
        console.log("Finalizando o cadastro da acomoda\u00E7\u00E3o familia super!");
    };
    return CadastroAcomodacaoFamiliaSuper;
}(processo_1.default));
exports.default = CadastroAcomodacaoFamiliaSuper;
