...
var ListagemAcomodacaoLivre = /** @class */ (function (_super) {
    __extends(ListagemAcomodacaoLivre, _super);
    function ListagemAcomodacaoLivre() {
        var _this = _super.call(this) || this;
        _this.acomodacoes = armazem_1.default.InstanciaUnica.Acomodacoes;
        return _this;
    }
    ListagemAcomodacaoLivre.prototype.processar = function () {
        var _this = this;
        console.clear();
        console.log('Iniciando a listagem das acomodações disponíveis...');
        console.log("-------------------------------------------------");
        var acomodacoesLivres = this.acomodacoes.filter(function (acomodacao) { return acomodacao.Disponivel; });
        acomodacoesLivres.forEach(function (acomodacao) {
            _this.impressor = new impressorAcomodacao_1.default(acomodacao);
            console.log(_this.impressor.imprimir());
            console.log("-------------------------------------------------");
        });
    };
    return ListagemAcomodacaoLivre;
}(processo_1.default));
exports.default = ListagemAcomodacaoLivre;
