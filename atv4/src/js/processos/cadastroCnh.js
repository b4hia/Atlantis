...
var CadastroCNH = /** @class */ (function (_super) {
    __extends(CadastroCNH, _super);
    function CadastroCNH(cliente) {
        var _this = _super.call(this) || this;
        _this.cliente = cliente;
        return _this;
    }
    CadastroCNH.prototype.processar = function () {
        ...
        var cnh = new documento_1.default(numero, TipoDocumento_1.TipoDocumento.CNH, dataExpedicao);
        this.cliente.Documentos.push(cnh);
    };
    return CadastroCNH;
}(processo_1.default));
exports.default = CadastroCNH;
