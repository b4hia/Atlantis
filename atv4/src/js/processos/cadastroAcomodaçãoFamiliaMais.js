...
var CadastroAcomodacaoFamiliaMais = /** @class */ (function (_super) {
    __extends(CadastroAcomodacaoFamiliaMais, _super);
    function CadastroAcomodacaoFamiliaMais() {
        var _this = _super.call(this) || this;
        _this.acomodacoes = armazem_1.default.InstanciaUnica.Acomodacoes;
        return _this;
    }
    CadastroAcomodacaoFamiliaMais.prototype.processar = function () {
        var diretor = new diretorFamiliaMais_1.default();
        this.acomodacoes.push(diretor.construir());
        console.log("Finalizando o cadastro da acomoda\u00E7\u00E3o familia mais!");
    };
    return CadastroAcomodacaoFamiliaMais;
}(processo_1.default));
exports.default = CadastroAcomodacaoFamiliaMais;
