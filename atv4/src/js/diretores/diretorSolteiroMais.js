...
var DiretorSolteiroMais = /** @class */ (function (_super) {
    __extends(DiretorSolteiroMais, _super);
    function DiretorSolteiroMais() {
        var _this = _super.call(this) || this;
        _this.armazem = armazem_1.default.InstanciaUnica;
        _this.construtor = new construtorAcomodacao_1.default();
        return _this;
    }
    DiretorSolteiroMais.prototype.construir = function () {
        var objetoConstrutor = this.construtor;
        objetoConstrutor.NomeAcomodacao = NomeAcomadacao_1.NomeAcomadacao.SolteiroMais;
    ...
    DiretorSolteiroMais.prototype.gerarIdentificadorAcomodacaoAleatorio = function () {
    ...
    return DiretorSolteiroMais;
}(diretor_1.default));
exports.default = DiretorSolteiroMais;
